...
public class AssetAlwaysReingestTests : IClassFixture<PresentationAppFactory<Program>>
{
    ...
    public AssetAlwaysReingestTests(StorageFixture storageFixture, PresentationAppFactory<Program> factory)
    {
        ...
        httpClient = factory.ConfigureBasicIntegrationTestHttpClient(storageFixture.DbFixture,
            appFactory => appFactory.WithLocalStack(storageFixture.LocalStackFixture)
                .WithConfigValue("AlwaysReingest", "true"),
            services => 
                services
    ...
    [Fact]
    public async Task UpdateManifest_ReingestsAsset_WhenReingestingUntrackedAssetWithAlwaysReingest()
    {
        // Arrange
    ...
    [Fact]
    public async Task UpdateManifest_ReingestsAsset_WhenReingestingTrackedAssetWithAlwaysReingest()
    {
        // Arrange
        var (slug, id, assetId, canvasId) = TestIdentifiers.SlugResourceAssetCanvas();
    ...
    [Fact]
    public async Task UpdateManifest_ReingestsAsset_WhenReingestingTrackedAssetInAnotherManifestWithAlwaysReingest()
    {
        // Arrange
        var (slug, id, assetId, canvasId) = TestIdentifiers.SlugResourceAssetCanvas();
    ...
    [Fact]
    public async Task UpdateManifest_CreatesManifestAndReingestsAsset_WhenReingestingTrackedAssetInAnotherManifestWithAlwaysReingest()
    {
        // Arrange
        var (slug, id, assetId, canvasId) = TestIdentifiers.SlugResourceAssetCanvas();
