...
public class CanvasPaintingMergerException : Exception
{
    ...
    public CanvasPaintingMergerException(string? expected, string? actual, string? message) : base(message)
    {
        Expected = expected;
        Actual = actual;
    }
    ...
    public CanvasPaintingMergerException(string? expected, string? actual, string? message, Exception? innerException) :
