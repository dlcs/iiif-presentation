...
public interface ITypesenseClient
{
    ...
    Task DeleteAliasAsync(string aliasName, bool ignoreIfMissing = false, CancellationToken cancellationToken = default);
    ...
    Task<IReadOnlyCollection<JObject>> ExportDocumentsAsync(string collectionName, string? includeFields = null,
        CancellationToken cancellationToken = default);
